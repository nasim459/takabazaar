...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 28, 2017 at 11:48 AM
...
(4, 'Ralit Group', 2, 'Ralit Group', 'ap/images/advertise/k6NlrGCrJuYXvBGIKHYG.png', 'ralitsoft.com', 0, 'Ralit Group', NULL, NULL),
...
CREATE TABLE `applyings` (
  ...
  `aply_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '0=success, 1=request, 2=pending',
  ...
  `card_id` int(3) NOT NULL DEFAULT '0' COMMENT 'foreign_key_of_cards_table',
  `carddebit_id` int(3) NOT NULL DEFAULT '0',
  `user_rating_star` tinyint(1) NOT NULL DEFAULT '2' COMMENT 'user_give_rating'
...
INSERT INTO `applyings` (`id`, `aply_name`, `aply_mobile`, `aply_email`, `aply_location`, `aply_company_name`, `aply_position`, `aply_year_transaction`, `aply_trade_licence`, `aply_monthly_income`, `aply_loan_exit`, `bank_id`, `aply_status`, `created_at`, `aply_offering_type`, `investment_id`, `loan_id`, `insurance_id`, `card_id`, `carddebit_id`, `user_rating_star`) VALUES
(1, 'yamin alam sarker yamin alam sarker', '01751300314', 'yamin@gmail.com', 'dhanmondi', 'Dhurbin Lab', 'Developer', 2017, '78978978978', 30000, '3 years', 1, 2, '2017-09-14 10:36:20', 44, 15, 0, 0, 0, 0, 3),
(2, 'Chapa Baj', '01777888754', 'virus@gmail.com', 'Kalabagan', 'Ralit Soft', 'System Analysis & Designer', 2017, '5645645', 15000, '2 years', 2, 0, '2017-09-14 10:36:20', 33, 0, 3, 0, 0, 0, 2),
(3, 'hgjghjgh', '5645645654', 'rterter@gmail.com', 'Rajshahi', 'dfksl', 'kjlkj', 2017, '6876876786786', 23456, NULL, 6, 0, '2017-09-14 10:36:20', 33, 0, 4, 0, 0, 0, 2),
(4, 'Raihan Talakdur', '01751300345', 'raihanA@gmail.com', 'Faridpur', 'fkjsfjsfjs', 'fsdfdk sdf sdfj fksd f', 2017, NULL, 76567567, '2019', 5, 0, '2017-09-14 10:36:20', 33, 0, 1, 0, 0, 0, 2),
(5, 'Kim Rafi', '01677788898', 'rafi@gamil.com', 'Norsingdi', 'kdjfakj', 'ksfjsk fdkf ', 2017, '432423423423423kjjk34', 23423, '2019', 8, 0, '2017-09-14 10:36:20', 44, 17, 0, 0, 0, 0, 4),
(6, 'dfd fdsfsda fsd', '4234234234', 'dfsdfsdfsd@gmail.com', 'dsfsdfsdfsdfs', 'dfsdfsdaf', 'fsdfsdfsdfsdfsd', 2017, '78978978978', 234234, '20129', 5, 0, '2017-07-09 18:00:00', 44, 18, 0, 0, 0, 0, 2),
(7, 'rwerwrwer rwer', '3453453', 'dgdfdfgdfgd@gmail.com', 'fgds dsfgdf gd', ' gdfgdfgsdf', 'gdfgdfgs fd gdfg', 2017, '5645645', 23423, '2022', 5, 2, '2017-07-09 18:00:00', 55, 0, 0, 2, 0, 0, 2),
(8, 'fsdfsdf', '4323423', 'dfdfgdg@fgdgf', 'dfgdfg', 'gdgd', 'gfdfgdf', 2017, 'dgdgf', 5345, 'terter', 8, 2, '2017-09-14 10:36:20', 44, 22, 0, 0, 0, 0, 2),
(9, 'fgfdgd', '546456456', 'tyrtyrtyty', 'trytry', 'trytryrtyrty546546', 'tryrtyrtyrt', 2017, '78978978978', 654645, '54645', 11, 2, '2017-09-14 10:36:20', 55, 0, 0, 1, 0, 0, 2),
(10, 'gfdgdfwerweq rweq rwqe rweq', '4543534', 'rwerwerwe', 'rwerwer', 'werwerwerwe', 'werewrwerwe', 2017, '78978978978', 442342, '324', 8, 2, '2017-09-14 10:36:20', 77, 0, 0, 0, 3, 0, 2),
(11, 'sfsd', '24234', 'gggg@fdsfds.dofd', 'erwrdfsdfs', 'werwe', 'rwerwe', NULL, NULL, 423432, NULL, 7, 2, '2017-09-14 10:46:19', 33, 0, 2, 0, 0, 0, 2),
(12, 'Rafi', '01777888777', 'rafi@gmail.com', 'Dhanmodi', 'Ralit Soft', 'Engineer', NULL, NULL, 40000, NULL, 5, 1, '2017-09-14 10:51:18', 33, 0, 3, 0, 0, 0, 2),
(13, 'Urmilla khatun', '01777888474', 'ralit@gamil.com', 'ksdjflksdjf sdklfjsdk fsdjlkf sdflk sdkf sdkf sdklf jsdlk sdf jskdlfj ksdjf sdfj  skdfj s', 'Ralit International University', 'no positon', NULL, NULL, 24234, NULL, 1, 1, '2017-09-14 15:41:57', 33, 0, 1, 0, 0, 0, 2),
(14, 'dfsdfsd', '88899944456', 'fggffd@sdfs', 'fdgdf gdfgdfgdfgdf', 'fdsdfsd', 'fsdf', NULL, NULL, 34534534, NULL, 2, 1, '2017-09-14 15:47:00', 33, 0, 2, 0, 0, 0, 2),
(15, 'fsdfsd', '56789345678', 'ralit@gamil.com', 'sdfsd fsdfsdfsdfsdfsd sd fds', 'werwerwer wer we', 'rwer', NULL, NULL, 234234, NULL, 1, 1, '2017-09-14 15:50:49', 33, 0, 7, 0, 0, 0, 2),
(16, 'redgfd', '23423423345', 'werwe@ralitsoft.com', 'Dhanmondi, Dhaka - 1207', '4234', 'dfssdf', NULL, NULL, 3423432, NULL, 8, 1, '2017-09-16 06:41:07', 77, 0, 0, 0, 1, 0, 2),
(17, 'Rumel Shamim', '01777888444', 'rumel@gmail.com', 'Dhaka , Dhanmondi, Sukrabad', 'dkfjsdkfsjdf sdkf', 'ffsdkff fsdfkj', NULL, NULL, 43242352, NULL, 11, 2, '2017-09-16 06:45:31', 77, 0, 0, 0, 5, 0, 2),
(18, 'Yamin alam sarker', '01777888999', 'yamin@gmail.com', 'kalabagan, dhanmjondi, dhaka', 'RalitSoft', 'director', NULL, NULL, 78787, NULL, 6, 0, '2017-09-16 07:32:04', 99, 0, 0, 0, 0, 4, 4),
(19, 'Jobayer', '01688999444', 'jobayer@gmail.com', 'khilkit, Uttra, Dhaka, Bangladesh', 'Ralit Host', 'Software Developer', NULL, NULL, 50000, NULL, 3, 0, '2017-09-16 07:49:18', 99, 0, 0, 0, 0, 5, 5),
(20, 'Nasim Rafi', '01777888999', 'fsdfsdf@sdfsd.vom', 'sdfsdfsdfsdf', 'fsdfsdf', 'sdfsdfsdf', NULL, NULL, 5000, NULL, 1, 1, '2017-09-21 10:21:22', 33, 0, 1, 0, 0, 0, 2),
(21, 'Nasim Hamid', '01888999456', 'sdfsf@fgfdg', 'sdfsdfds sdfsd', 'dfgdf', 'fgdfg', NULL, NULL, 5345345, NULL, 1, 0, '2017-09-21 10:21:56', 33, 0, 1, 0, 0, 0, 2),
(22, 'Nasim Ralit', '01888333777', 'fsdfsdf@sdfsd.vom', 'dfsdf sdfsdf', 'sdfs', 'fsd', NULL, NULL, 3434, NULL, 1, 0, '2017-09-21 10:22:34', 33, 0, 1, 0, 0, 0, 2),
(23, 'Nasim Soft', '01888333777', 'fsdfsdf@sdfsd.vom', 'fdsfsdfsd fsdf', NULL, NULL, NULL, NULL, 32423, NULL, 1, 0, '2017-09-21 10:22:54', 33, 0, 1, 0, 0, 0, 2),
(24, 'Nasim Virus', '01888333774', 'fsdfsddddf@sdfsd.vom', 'fdfdsf sdf sdf dsfsd fds', NULL, NULL, NULL, NULL, 4324, NULL, 1, 0, '2017-09-21 10:23:32', 33, 0, 1, 0, 0, 0, 2),
(25, 'Fahim akhandho khan', '01888777666', 'fahim@gmail.com', 'fgdf gdfgdf gdfg dfgdfg dfgdf dfg df', 'sdkfjsdlkfj', 'dsjfsdjfl', NULL, NULL, 50000, NULL, 1, 1, '2017-09-25 06:51:57', 33, 0, 1, 0, 0, 0, 2);
...
CREATE TABLE `banks` (
  ...
  `bank_type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '0=NBFI, 1=BFI,  [NBFI=Non Bank Finance Information]',
...
INSERT INTO `banks` (`id`, `bank_name`, `bank_type`, `bank_image_url`, `bank_status`, `created_at`, `updated_at`) VALUES
(1, 'The City Bank Ltd.', 1, 'y0ArEOiTxTfR1hwtIe8y.gif', 1, NULL, NULL),
(2, 'Prime Bank Ltd', 1, 'b_52.png', 0, NULL, NULL),
(3, 'United Commercial Bank Limited hhh', 1, 'b_53.png', 1, NULL, NULL),
(4, 'Standard Chartered Bank', 1, 'b_54.png', 1, NULL, NULL),
(5, 'Dutch-Bangla Bank Limited', 1, 'b_55.png', 0, NULL, NULL),
(6, 'AB Bank Limited', 1, 'b_56.png', 1, NULL, NULL),
(8, 'Ralt Bnk Limited', 0, 'i45mUdVA5y2ufNE4seMM.jpg', 1, NULL, NULL),
(10, 'Prime Bank Ltd', 1, '8Rp3fBnkBjEaK0myp7H6.png', 0, NULL, NULL),
(11, 'hgffhf', 0, '7HX0fMk6IaibqdHD8XzT.png', 1, NULL, NULL),
(12, 'rtet5 er tewr erterter', 1, 'LqKnYImTrZQHJBhCxN06.png', 0, NULL, NULL),
(14, 'dsfsdf sdf sdfsdf dsfsdfsdfsdf sd', 0, 'lx7ocv6Ts4uLqigzgQss.png', 1, NULL, NULL),
(15, 'Pdgdfgdsfg df g dsfg dfsg dfg', 1, '440ba6R8B4ETUg4JirZO.gif', 0, NULL, NULL),
(16, 'dfdfgdfgfdg dfgdf dfgdf', 1, 'Gwil0XkkVh0NXf0YFrMQ.jpg', 0, NULL, NULL),
(17, 'hfgh gf dfg fg dfg fg dfg df', 1, 'yVvwdlEPyfxY2rPKjZdq.jpg', 1, NULL, NULL),
(18, 'fgfd fgfd gf df dfg g gdfgdfgdfgdfg', 1, 'VB4qFa2H0bR9su7C0mDn.png', 0, NULL, NULL),
(19, 'Ralt Bnk Limited', 0, 'KOyDyhHau3Nk4xKImsvu.png', 1, NULL, NULL),
(20, 'dfgdfgdf gdfgdfgdf gdfg dfg', 1, 'pFjZpJpjGN5CqfjxwTeC.png', 1, NULL, NULL),
(21, 'ijh hfg hsgdfgdf gdsf', 1, 'kGakeUqwTn4oY5asbsHI.jpg', 0, NULL, NULL),
(22, 'ghfgh hfdg dfgd fg', 0, '9ebmzEM9fB7AjzASTSC2.gif', 1, NULL, NULL),
(23, 'gffdg sdfg dfgdfgdfg ', 1, 'n0Va7tKlOOhMFDdqkmQT.jpg', 1, NULL, NULL),
(24, 'sdfsd fsdfsdafsdf', 1, 'dOMa2dA8MEEQf5QsK7th.jpg', 1, NULL, NULL),
(25, 'dsfsdfs dsf sdfds sdaf sd', 0, 'rkJRVO0KEjY3HVWSSiJN.png', 1, NULL, NULL),
(26, 'Ralit Soft Bank', 1, '7CTuPBydhbTCTBiPfVs8.jpg', 0, '2017-07-11 10:55:29', '2017-07-11 10:55:29'),
(27, 'Nasim Bank Limited', 1, 'nUIaH1Ab6YgPUPrwjO40.gif', 1, '2017-07-11 11:22:54', '2017-07-11 11:22:54'),
(28, 'Ralt Bnk Limited', 0, 'ap/images/banks/MsGH9DfFwkAJYfEUe7rT.png', 0, '2017-07-11 11:58:35', '2017-07-11 11:58:35'),
(29, 'yuikuy, io870 890 ,9890-p.', 1, 'ap/images/banks/sd13ZCTOCbHrqAv6lPWk.jpg', 0, '2017-09-11 12:17:32', '2017-09-11 12:17:32'),
(31, 'FinFoBD Bank Ltd', 1, 'IMS2W5wT0goYeYaUDNOo.png', 0, '2017-09-25 07:53:13', NULL);
...
(7, 'ralitsofti@gmail.com', 1, '2017-09-19 15:23:37', NULL),
(8, 'tonmoykhan@gmail.com', 1, '2017-09-19 15:29:12', NULL);
...
(1, 'Gold Local (Master Card)', 'mE9r7JtKzp2vpDRjiHq8.jpg', 1, '2017-09-16 08:17:00'),
(2, 'Classic Local (Master)', 'cj0Tnwiw0cHxDbhrCM3c.jpg', 1, '2017-09-16 08:17:19'),
(3, 'VISA Ralit New', 'YLFMJPaUwAlQuNxGlObc.jpg', 0, '2017-09-16 08:17:43'),
(5, 'Classic Local (VISA)', 'cBx9g3zfrRvKZ3fvx7Mu.png', 1, '2017-09-16 08:17:32'),
(6, 'VISA Classic Dual', 'csBpRdInslNTISRIrLL0.jpg', 1, '2017-09-16 08:17:56'),
(7, 'Classic Local (Master Card)', 'M9lX9aApL20vJai6V8DR.jpg', 1, '2017-09-16 08:16:09'),
(8, 'Platinum Local (VISA)', 'eYAdPaVAzTxY1zBUtOdQ.jpg', 1, '2017-09-16 08:23:33'),
(9, 'Platinum Local (VISA)', 'reHsAF1XbtZ9K8amBlht.png', 1, '2017-09-16 08:22:49');
...
(18, 'Health Care', 1, '2017-09-16 17:53:12', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `commentreplaies`
--

CREATE TABLE `commentreplaies` (
  `id` int(6) NOT NULL COMMENT 'Primary-Key',
  `comment_replay_desc` text,
  `comment_replay_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '0=unPublish, 1=Publish',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `blog_id` int(4) NOT NULL COMMENT 'Foreign-Key',
  `bloguser_id` int(3) NOT NULL COMMENT 'Foreign-Key',
  `comment_id` int(2) NOT NULL COMMENT 'Foreign-Key'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='commentreplaies_777';

--
-- Dumping data for table `commentreplaies`
--

INSERT INTO `commentreplaies` (`id`, `comment_replay_desc`, `comment_replay_status`, `created_at`, `blog_id`, `bloguser_id`, `comment_id`) VALUES
(1, 'fdgfdgdf dfgdfg', 1, '2017-09-17 10:47:59', 14, 14, 2),
(2, 'We are with you.', 1, '2017-09-17 10:49:29', 14, 15, 4),
(3, 'dsfdsf sdfsdfsdfsdf sdf sd sf', 1, '2017-09-17 10:51:38', 14, 16, 5),
(4, 'sdfsdf sdfsdfsdfsd', 1, '2017-09-18 16:56:00', 14, 17, 2),
(5, 'dkfjsdk fsdfkj kjfdk fjkdf sdfs df sd', 1, '2017-09-25 13:01:37', 18, 18, 1),
(6, 'idfsdkjf sdfhsdfkjsdh fsdjf sdjfhsdfjk sdhfd kjffhj nmjkjkhjkdkgjfdfoidsf dfjsdojfklfoiweurioweui fhiu yuiyewquiyheiquw ehauihd asdhasd', 1, '2017-09-25 13:02:34', 18, 19, 1),
(7, 'বিল গেটস স্বয়ংই তোমাদের মেধাকে চিনতে পেরেছে সেটাই বড় পুরস্কার। স্যলুট তোমাদের মতো বাংলাদেশের কৃতি সন্তানদের।', 1, '2017-09-27 17:59:43', 14, 20, 4),
(8, 'ffslkdfjklsdjf dsjf lksdjfksd fjksd fkj skldfj sdkl fklsdj fklsdj flksdjf lksdjflksdjflksdjflksdjlkfjsdklfjsdklfjsdlkfj sdkljf lkjfsdlkfjsdalkf jklsdfj sdlkfjsd lkjfskld fjlksdjf lksdfjklsd fjklsdf jskdl', 1, '2017-09-27 18:15:27', 14, 21, 4);
...
CREATE TABLE `comments` (
  ...
  `blog_id` int(4) NOT NULL COMMENT 'Foreign-Key',
  `bloguser_id` int(3) NOT NULL COMMENT 'Foreign-Key'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='comments_666';

--
-- Dumping data for table `comments`
--

INSERT INTO `comments` (`id`, `comment_desc`, `comment_status`, `created_at`, `blog_id`, `bloguser_id`) VALUES
(1, 'gdfgdf sdjkf sdafkljsda jsdk fksdj fsdjfk sdfklsdfsdk fjsdklf jsd fjsd fksdjf sdkjf skd fskdlf ksdfj ksdf skdjf ksdl fsdkjf lsdkfj skldfjksd fklsd fklsf lksadjf lksdj fslkdfjsldkjfslfskldjf sldkjflksdjflksdjflksdjflksdjfklsjkfjweoiruioweur oiweu rioweu rioweu riweur iweoru werujfskhsdljfklsd ', 1, '2017-09-17 04:17:03', 18, 9),
(2, 'এটাই হলো সৃজনশীল আইকিউ। সাবাস এগিওেয় যাওয় খান একাডেমি। বাঙলাদেশে শিক্ষকরা যেখানে ক্লাসে ফাকি দিয়ে কোচিং বাণিজ্য করছে। আর খান একাডেমি অনলাইনে শিক্ষা দিচ্ছে ।  টাকা ছাড়া মানুষের সেবায়ও খ্যাতি আছে তা শিক্ষকরা কবে বুঝবে।', 1, '2017-09-17 04:22:00', 14, 10),
(3, 'তোমরাই সত্যিকারের অর্থে সাধারন্যের দৌড় গোড়ায়  তথ্য প্রযুক্তি নিয়ে গিয়ে মানুষের সেবা করার সফল কারিগর আর তাই তোমাদের জন্য কোনো স্টেজ পুরস্কারের দরকার নেই । বিল গেটস স্বয়ংই তোমাদের মেধাকে চিনতে পেরেছে  সেটাই বড় পুরস্কার। স্যলুট তোমাদের মতো বাংলাদেশের কৃতি সন্তানদের।', 1, '2017-09-17 04:26:33', 14, 11),
(4, 'এগিয়ে যান সালমান খান, দেশ আপনার মত মানুষদের জন্য গর্বিত​', 1, '2017-09-17 04:27:35', 14, 12),
(5, 'sdfjsdk fsldkfj skdjf lkdsj fsdakjfkdlsjf fsfsd fsdf sd fsdfsdfsdf sdfsdfdfgfdjklj gkjk gjklfdjflkdgl;dfkg ;kfg ldfk gdfgj ksdjfksldjfkdsl fds fdsj  fj  kfdskfjkldsjf skdfjkldsfjksd dsklfjsdkj fklsdjfkljdskf sdkljf dsjfksdj fkdjfkjsdkfjoeurioejflkwej fwejroiweurioewu ewi riewu rewr weiur', 1, '2017-09-17 09:47:45', 14, 13);
...
--
-- Table structure for table `headerimages`
--

CREATE TABLE `headerimages` (
  `id` int(2) NOT NULL COMMENT 'primary_key',
  `header_image_url` varchar(200) DEFAULT NULL,
  `header_image_type` tinyint(1) DEFAULT NULL COMMENT '1=home_loan, 2=car_loan,3=personal_loan, 4=sme_loan,5=working_capital_loan, 6=others_loan, 7=saving_account, 8=Fixed_account, 9=mutual_account, 10=life_insurance, 11=bike_insurance, 12=car_insurance, 13=marine_insurance, 14=fire_insurance, 15=accident_insurance, 16=credit_card, 17=debit_card,18=about_us',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0=unPublish, 1=publish',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `headerimages`
--

INSERT INTO `headerimages` (`id`, `header_image_url`, `header_image_type`, `status`, `created_at`) VALUES
(1, 's9nt9HFzMnM3cL6bOtmO.jpg', 1, 1, '2017-09-21 05:21:09'),
(2, 'tvjlmPdU0EN3aBzPGQs0.jpg', 2, 1, '2017-09-20 16:02:59'),
(3, 'JnM5S1dKk6bWacJ18iF1.jpg', 3, 1, '2017-09-21 05:03:47'),
(4, '0Ee4F3A2xWotXmmbVtrE.jpg', 4, 1, '2017-09-20 16:37:36'),
(5, 'QwnK2qqPdrtcRi2wAg1U.jpg', 5, 0, '2017-09-20 16:37:45'),
(6, 'obFeCBTABU1moblUcer3.jpg', 6, 1, '2017-09-20 16:37:54'),
(7, 'gdfgdf', 7, 0, '2017-09-20 13:51:23'),
(8, 'gdf', 8, 0, '2017-09-20 13:51:25'),
(9, 'VR2l4IgmAoEMDmFyGe5O.jpg', 9, 1, '2017-09-21 05:26:30'),
(10, '', 10, 0, '0000-00-00 00:00:00'),
(11, '', 11, 0, '0000-00-00 00:00:00'),
(12, '', 12, 0, '0000-00-00 00:00:00'),
(13, 'Y7XMxnM3tYShbNNN4rBN.jpg', 13, 0, '2017-09-20 14:20:28'),
(14, '', 14, 0, '0000-00-00 00:00:00'),
(15, '', 15, 0, '0000-00-00 00:00:00'),
(16, 'ZofpaZPoF8A2BegCSeDN.jpg', 16, 0, '2017-09-20 17:06:49'),
(17, 'FTORMbkhQJVwtRkusGpx.jpg', 17, 0, '2017-09-20 17:07:00'),
(18, 'dk2bdDFs1Wvv1kbZKs9l.jpg', 18, 0, '2017-09-21 05:17:01');
...
CREATE TABLE `insurances` (
  ...
  `insr_rating` tinyint(1) NOT NULL DEFAULT '0',
  `insr_review` int(6) DEFAULT NULL,
...
INSERT INTO `insurances` (`id`, `insr_type`, `insr_person_type`, `insr_sum_insured`, `insr_period`, `insr_cover_type`, `insr_monthly_payout`, `insr_lump_sum_payout`, `insr_claim_ratio`, `insr_premium`, `insr_rating`, `insr_review`, `insr_features_benefits`, `insr_eligibility`, `insr_requirements`, `insr_rate`, `insr_status`, `created_at`, `bank_id`) VALUES
(1, 1, 2, 200000, 6, '2', 4546, 67567, 97, 7878, 0, 0, '<p>fdgdfgdfg==================</p>', '<p>dfgdfgdfs==========</p>', '<p>dfgdfgd===================</p>', 'dfgdfgdf', 0, NULL, 1),
(2, 2, 2, 100000, 5, NULL, NULL, NULL, 97, 2500, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, 2),
(3, 4, 2, 58888, 3, '2', 788, 5666, 7, 5666, 0, NULL, '<p>hhhhhhhhhhhg</p>', '<p>hhhhhhhhhhhg==========</p>', '<p>hhhhhhhhhhhg</p>', NULL, 1, NULL, 8),
(4, 1, 2, 50000, 3, '1', 5005555, 16000, 8, 5200, 0, NULL, '<p>kjhj kjh kjhjkh</p>', '<p>kjhj kjh kjhjkh</p>', '<p>kjhj kjh kjhjkh</p>', NULL, 1, NULL, 10),
(5, 1, 1, 40000, 3, '2', 4000, 451112, 5, 1500, 0, NULL, '<p>hgh ghjklhjklhkjhkjh jklhjklkjlk lkjlk lk</p>', '<p>hgh ghjklhjklhkjhkjh jklhjklkjlk lkjlk lk</p>', '<p>hgh ghjklhjklhkjhkjh jklhjklkjlk lkjlk lk</p>', NULL, 1, NULL, 3),
(6, 2, 2, 400000, 2, '1', 4000, 50000, 6, 6000, 0, NULL, '<p>tyyutyutyutyut</p>', '<p>tyyutyutyutyut</p>', '<p>tyyutyutyutyut</p>', NULL, 1, NULL, 3),
(7, 3, 2, 5412123, 4, '2', 40000, 532200, 8, 4122, 0, NULL, '<p>ghfghfghfg gh fhgfhgfhgfhgf hfhg fhg hg &nbsp;ghfgh &nbsp; h</p>', '<p>ghfghfghfg gh fhgfhgfhgfhgf hfhg fhg hg &nbsp;ghfgh &nbsp; h</p>', '<p>ghfghfghfg gh fhgfhgfhgfhgf hfhg fhg hg &nbsp;ghfgh &nbsp; h</p>', NULL, 1, NULL, 12),
(8, 2, 2, 55555, 4, '1', 4000, 400000, 7, 1500004, 0, NULL, '<p>f sdfsdf sdfsdfsd</p>', '<p>f sdfsdf sdfsdfsd</p>', '<p>f sdfsdf sdfsdfsd</p>', NULL, 1, NULL, 6),
(9, 1, 2, 40000, 5, '2', 5000, 46000, 7, 5745, 0, NULL, '<ol><li>Unlimited transactions (both deposit and withdrawals) are allowed.</li><li>Personalized MICR Cheque Book is available.</li><li>No withdrawal notification required.</li><li>Nominal service charge.</li><li>Any branch banking facility (Cash withdrawal and deposit from any branch)</li><li>Bank accepts Standing Instructions from A/C holders.</li><li>Nomination facility is available to nominate beneficiary for account proceeds.</li><li>Charge free statement of A/C, Balance Confirmation Certificate twice in a year on half yearly basis.</li></ol>', '<ol><li>Unlimited transactions (both deposit and withdrawals) are allowed.</li><li>Personalized MICR Cheque Book is available.</li><li>No withdrawal notification required.</li><li>Nominal service charge.</li><li>Any branch banking facility (Cash withdrawal and deposit from any branch)</li><li>Bank accepts Standing Instructions from A/C holders.</li><li>Nomination facility is available to nominate beneficiary for account proceeds.</li><li>Charge free statement of A/C, Balance Confirmation Certificate twice in a year on half yearly basis.</li><li>Option is available to collect e - Statement on monthly basis.</li></ol>', '<ol><li><em><strong>Unlimited transactions (both deposit and withdrawals) are allowed.</strong></em></li><li><em><strong>Personalized MICR Cheque Book is available.</strong></em></li></ol><ul><li>&nbsp;</li></ul>', NULL, 1, NULL, 12),
(10, 2, 3, 4500, 2, '2', 1000, 56000, 87, 25000, 0, NULL, '<p>&nbsp;fsdfdsfdsfds s &nbsp;sd faaaaaaaaaa s &nbsp; &nbsp; &nbsp; sdfdsf dsfds</p>', '<p>dsf &nbsp; &nbsp; &nbsp;dsfds dsf dsfgfdgfd fdgfdgfdgfdgdf</p>', '<p>hghggggggggg fddsfsdfds fdf ds fdfdfdsf&nbsp;</p>', NULL, 1, '2017-09-24 16:43:10', 3),
(11, 3, 1, 5454, 4, '2', 345345, 34534534, 4, 54545, 0, NULL, '<p>gggggggggggggggggggggggggggg</p>', '<p>gggggggggggggggg</p>', '<p>ggggggggggggggggg</p>', NULL, 1, '2017-09-24 17:15:59', 3);
...
(1, 1, 1, 200000, 2, 11.5, 930, 4525, 10, NULL, NULL, NULL, '<ol><li>Unlimited transactions (both deposit and withdrawals) are allowed.</li><li>Personalized MICR Cheque Book is available.</li><li>No withdrawal notification required.</li><li>Nominal service charge.</li><li>Any branch banking facility (Cash withdrawal and deposit from any branch)</li><li>Bank accepts Standing Instructions from A/C holders.</li><li>Nomination facility is available to nominate beneficiary for account proceeds.</li><li>Charge free statement of A/C, Balance Confirmation Certificate twice in a year on half yearly basis.</li><li>Option is available to collect e - Statement on monthly basis.</li></ol>', '<ul><li><strong><em>Requirements<a href="mailto:mdnasim.info@gmail.com?subject=ghghh&amp;body=hghjggh%20hgh%20ghj%20">mdnasim.info@gmail.com</a></em></strong></li><li><strong><em>Rate of Interest &amp; Fees</em></strong></li><li><strong><em>No Interest is paid on CD Account.</em></strong></li><li><strong><em>Fees and Charges: As per existing schedule of charges which is separately displayed/shown on the web site</em></strong></li></ul>', NULL, '<ol><li>CD Account can be opened both for Individuals and Firms/Corporate/ Autonomous Bodies etc.</li><li>CD Account can be opened both for resident and non - resident Bangladeshi Nationals.</li><li>Age bar for Personal CD Account: 18 years or above.</li><li>Single/Joint account can be opened.</li><li>Minor account can be opened under the supervision of his / her / their guardian.</li><li>Account can be opened in the name of Trust / Club / Association / Societies / Non - Trading Concerns.=====</li></ol>', 0, NULL, NULL, 1),
...
(21, 1, 3, 3000000, 4, 11.5, 930, 4525, 7, 12, NULL, NULL, '<p>gggggggggggggggg</p>', '<p>hgggggggggg</p>', NULL, '<p>gggggggggggggggggggggjh</p><p>lkjhjkhjkhj</p><p>hkjhk</p><p>hkjhjk</p>', 1, NULL, NULL, 2),
...
CREATE TABLE `ratings` (
  `id` int(6) NOT NULL COMMENT 'PrimaryKey',
  `rating_star` tinyint(1) NOT NULL DEFAULT '2' COMMENT 'this_is_the_star_rating',
  `loan_id` int(4) NOT NULL DEFAULT '0',
  `investment_id` int(4) NOT NULL DEFAULT '0',
  `insurance_id` int(4) NOT NULL DEFAULT '0',
  `card_id` int(3) NOT NULL DEFAULT '0',
  `carddebit_id` int(3) NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ratings_';

--
-- Dumping data for table `ratings`
--

INSERT INTO `ratings` (`id`, `rating_star`, `loan_id`, `investment_id`, `insurance_id`, `card_id`, `carddebit_id`, `created_at`) VALUES
(1, 2, 2, 0, 0, 0, 0, '2017-09-13 18:31:40'),
(2, 2, 14, 0, 0, 0, 0, '2017-09-13 18:38:03'),
(3, 2, 16, 0, 0, 0, 0, '2017-09-13 18:39:18'),
(4, 2, 0, 8, 0, 0, 0, '2017-09-13 18:40:48'),
(5, 2, 1, 0, 0, 0, 0, '2017-09-16 12:42:46'),
(6, 2, 1, 0, 0, 0, 0, '2017-09-16 12:43:38'),
(7, 2, 0, 0, 0, 4, 0, '2017-09-16 12:53:16'),
(8, 2, 0, 0, 0, 0, 4, '2017-09-16 12:59:42'),
(9, 2, 0, 0, 0, 0, 1, '2017-09-16 13:01:10'),
(10, 2, 0, 0, 0, 3, 0, '2017-09-16 13:01:48'),
(11, 2, 2, 0, 0, 0, 0, '2017-09-16 13:04:01'),
(12, 2, 0, 14, 0, 0, 0, '2017-09-16 13:10:32'),
(13, 2, 0, 0, 0, 4, 0, '2017-09-16 13:34:37'),
(14, 2, 0, 0, 0, 10, 0, '2017-09-16 13:34:48'),
(15, 2, 0, 0, 0, 10, 0, '2017-09-16 13:35:34'),
(16, 2, 0, 0, 0, 10, 0, '2017-09-16 13:35:48'),
(17, 2, 0, 0, 0, 9, 0, '2017-09-16 13:36:24'),
(18, 2, 0, 0, 0, 9, 0, '2017-09-16 13:36:37'),
(19, 2, 0, 0, 0, 9, 0, '2017-09-16 13:36:49'),
(20, 2, 0, 0, 0, 9, 0, '2017-09-16 13:37:13'),
(21, 2, 0, 0, 0, 9, 0, '2017-09-16 13:37:24'),
(22, 4, 0, 6, 0, 0, 0, '2017-09-21 09:44:52');
...
CREATE TABLE `reviews` (
  ...
  `r_email` varchar(256) DEFAULT NULL,
  `r_message` text,
  `loan_id` int(4) NOT NULL DEFAULT '0',
  `investment_id` int(4) NOT NULL DEFAULT '0',
  `insurance_id` int(4) NOT NULL DEFAULT '0',
  ...
  `carddebit_id` int(3) NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='reviews_2222';

--
-- Dumping data for table `reviews`
--

INSERT INTO `reviews` (`id`, `r_name`, `r_email`, `r_message`, `loan_id`, `investment_id`, `insurance_id`, `card_id`, `carddebit_id`, `created_at`) VALUES
(1, 'Md Nasim', 'nasim@gmail.com', 'Very better service, i respect them', 2, 0, 0, 0, 0, '2017-09-13 18:31:40'),
(2, 'Rafi Ahamed', 'rafi@gmail.com', 'Wow good Service', 2, 0, 0, 0, 0, '2017-09-13 18:38:03'),
(3, 'Tomal Kham', 'tomal_kjflsdkfjdfsdjkfsdj@ralitsoft.com', 'It''s a bad process, that''s really boring', 1, 0, 0, 0, 0, '2017-09-13 18:39:18'),
(4, 'Gurand Sikdar', 'girand@gmail.com', 'df sdf sdfsdfprocess is very good process.', 0, 1, 0, 0, 0, '2017-09-13 18:40:48'),
(5, 'karmul hassan', 'kamrul@gmail.com', 'write something  lfkdlfksd fsdk fsdklf sdfjsdklfjsd klfjsdklf jsdkflsdjkf sdklfjsdklfsdklfsd kljfds klsdj fklsdjoweiurioweur weir wejrioweurioweu ruweou weiorueur weiu rweijriojwelkrjsklfj sdlkfj', 1, 0, 0, 0, 0, '2017-09-16 12:42:46'),
(6, 'Sagar Khan', 'sagar@gmail.com', 'sagar kahjfljsdlfksdj sdlkfj sdklf sdklf sdklf', 1, 0, 0, 0, 0, '2017-09-16 12:43:38'),
(7, 'Tomal Akram', 'tomal@gmail.com', 'tomal kfjsdf fk sdkfsd fs fsd', 0, 0, 0, 4, 0, '2017-09-16 12:53:16'),
(8, 'Hemal Himo', 'hemal@gamil.com', 'this credit card is very very vferysdfsd sdf sdf dfs', 0, 0, 0, 0, 4, '2017-09-16 12:59:42'),
(9, 'sdkfsd', 'kfsdl@gmail.com', 'sdkfjsd fsd fsdklfj sdfk jsdf sdfsd fdsf sd', 0, 0, 0, 0, 1, '2017-09-16 13:01:10'),
(10, 'gfdgd', 'kamrul@gmail.com', 'sdfsdf dsfsdfdsfsdds fsdf df ssdf sd fsd', 0, 0, 0, 3, 0, '2017-09-16 13:01:48'),
(11, 'loan person loan', 'person@ralitSoft.com', 'dfkjdslf ksd ksdklfjsd kfjsd sdksdfs sadf sdaf sfd sdf d sdfsd fds sd', 2, 0, 0, 0, 0, '2017-09-16 13:04:01'),
(12, 'Nasim from investment', 'nasdidsfs@ksjfksdco.com', 'dsfksdfsd fds sfsd fd dsfds fasd', 0, 14, 0, 0, 0, '2017-09-16 13:10:32'),
(13, 'terter', 'sagar@gmail.com', 'dfgdfg', 0, 0, 0, 4, 0, '2017-09-16 13:34:37'),
(14, 'dgdfg', 'jobayer@gmail.com', 'dfgdfgdsf', 0, 0, 0, 10, 0, '2017-09-16 13:34:48'),
(15, 'rtterte', 'sagar@gmail.com', 'erterter b wertdfgfdg', 0, 0, 0, 10, 0, '2017-09-16 13:35:34'),
(16, 'ter tertdggdf g', 'kamrul@gmail.com', 'dgdf gdf gdfg', 0, 0, 0, 10, 0, '2017-09-16 13:35:48'),
(17, 'Hgfhfghfg', 'jobayer@gmail.com', 'fgh fg h hgfgh gh', 0, 0, 0, 9, 0, '2017-09-16 13:36:24'),
(18, 'ghgfh fghf', 'yamin@gmail.com', 'fdgdfgdf', 0, 0, 0, 9, 0, '2017-09-16 13:36:37'),
(19, 'dsfdsf', 'yamin@gmail.com', 'dsfsdfsd', 0, 0, 0, 9, 0, '2017-09-16 13:36:49'),
(20, 'sdfsdfsdf', 'jobayer@gmail.com', 'fsdfsd', 0, 0, 0, 9, 0, '2017-09-16 13:37:13'),
(21, 'sdfsdf', 'tomal@gmail.com', 'sfsdfsdfsd', 0, 0, 0, 9, 0, '2017-09-16 13:37:24'),
(22, 'Bang malaker khan', 'bag_malaker_khan@gmail.com', 'jdkfhsadjkfhsdfjsdkf sdkjfsd hfsdj fjsdk fsdjkfoisdu sdijfoisd fsdhfkjsdhfkjsd jdsfkjsd kflj lkdjf sdklfjklsdfj', 0, 5, 0, 0, 0, '2017-09-25 12:39:29'),
(23, 'tuhin alam', 'tuhin@gmail.com', 'dsjfklj sdfksdjfk dskjf sdkjf dsfk jdfkj kfdjdskfsdkfjdskjfklsdj sdfkjsdkfjksdjfoweiuriweo weiurioweur esjfksd jvjnoi ujriwej uweirjwsfjsdlk', 0, 5, 0, 0, 0, '2017-09-25 12:40:56'),
(24, 'Tomo Hilllomeo', 'tomekjf@ralitSoft.com', 'dkfjadsk fjsdkfjsdkfj skdlfjkdsjf kdkdfjkdj dkjfds', 0, 0, 0, 1, 0, '2017-09-25 12:43:06'),
(25, 'lskdjflksdjf sdkjflksdjfksdjfksdjfsd', 'kdjsfksdjfklsdjflksdjf@kfsdjf.com', 'The best chef knife can’t be defined by a single aspect or even a set of features. It’s really all about hand-feel: The knife you choose should comfortably tackle a variety of tasks in the kitchen and it should ideally function as an extension of your forearm. We consulted with professional chefs, a cooking instructor, and a knife expert, and then we headed to the kitchen to chop, dice, and peel with 11 best-selling chef knives to see which ones stood out in a competitive', 0, 0, 0, 1, 0, '2017-09-25 12:45:48'),
(26, 'Babllow Choyan', 'yourmail@yahoo.com', 'kjfdskfj fjdkfjdkThe best chef knife can’t be defined by a single aspect or even a set of features. It’s really all about hand-feel: The knife you choose should comfortably tackle a variety of tasks in the kitchen and it should ideally function as an extension of your forearm. We consulted with professional chefs, a cooking instructor, and a knife expert, and then we headed to the kitchen to chop, dice.', 0, 0, 0, 1, 0, '2017-09-25 12:46:47'),
(27, 'gfdgdfg', 'dfgdfgdfg@fgdfsg', 'dfgdfgdsfgd', 0, 0, 0, 2, 0, '2017-09-25 12:46:59'),
(28, 'Tonmoy alam Suma', 'suma@ralitsoft.com', 'dkfdfk dkfjdkfjd sdkjfksdjf sdjfksdklfj dsf', 0, 0, 0, 0, 1, '2017-09-25 12:50:02');
...
(1, 'Admin', 'An Admin', '2017-09-11 03:32:03', '2017-09-11 03:32:03'),
(2, 'Blog-User', 'A blog user', '2017-09-11 03:32:03', '2017-09-11 03:32:03');
...
CREATE TABLE `users` (
  ...
  `password` varchar(100) NOT NULL COMMENT 'blog_user_password',
...
INSERT INTO `users` (`id`, `role_id`, `user_name`, `email`, `password`, `user_image`, `status`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, NULL, 'Ralit Soft', 'ralitsoft@gmail.com', 'asd', 'fe/img/blog_pic/tkkbQPAOQap5CFHimdFu.jpg\n', 0, NULL, '2017-09-08 14:15:48', '0000-00-00 00:00:00'),
(2, NULL, 'Ralit Host', 'ralithost@gmail.com', 'asd', NULL, 1, NULL, '2017-09-07 04:20:49', '0000-00-00 00:00:00'),
(3, NULL, 'Tuhin', 'tuhin@gmail.com', 'asd', NULL, 0, NULL, '2017-09-07 04:16:22', '0000-00-00 00:00:00'),
(4, NULL, 'Yamin Alam Sarker', 'yamin@gamil.com ', 'asd', 'fe/img/blog_pic/tkkbQPAOQap5CFHimdFu.jpg\n', 1, NULL, '2017-09-08 14:15:50', '2017-09-07 04:17:32'),
(5, NULL, 'Raihan Talukdar', 'raihan@gmail.com', 'asd', NULL, 1, NULL, '2017-09-07 04:18:38', '2017-09-07 04:18:38'),
(6, NULL, 'Sakib Al Alam', 'sakib@ralitsoft.com', 'asd\r\n', NULL, 0, NULL, '2017-09-19 15:43:03', '2017-09-07 04:19:17'),
(7, NULL, 'tomal', 'tomal@gmail.com', '123', NULL, 1, NULL, '2017-09-07 11:54:55', '2017-09-07 11:54:55'),
(8, NULL, 'rafi', 'rafi@gmail.com', '123', NULL, 1, NULL, '2017-09-07 11:57:32', '2017-09-07 11:57:32'),
(9, NULL, 'nasim', 'nasimvirus@gmail.com', 'asd', NULL, 1, NULL, '2017-09-17 04:17:03', NULL),
(10, NULL, 'farhan tanvir kousik', 'farhan@gmail.com', 'asd', NULL, 0, 'gaOwCs9xHPkG9WCQx9WW2VUCnSWD29oWmW0mDWY8Wiw2BbNns8w6MWWsxNKZ', '2017-09-28 08:33:00', NULL),
(11, NULL, 'mohakash bloger', 'mohakash@gmail.com', 'mohakash', NULL, 1, NULL, '2017-09-17 04:26:33', NULL),
(12, NULL, 'Aminul Islam', 'aminul_islam@gmail.com', 'aminul_islam', NULL, 1, NULL, '2017-09-17 04:27:35', NULL),
(13, NULL, 'Woadud Islam', 'woadud@gmail.com', 'asd', NULL, 1, NULL, '2017-09-17 09:47:44', NULL),
(14, NULL, 'dfgdfgdfgdf', 'nasimvirus@gmail.com', 'asd', NULL, 1, NULL, '2017-09-17 10:47:59', NULL),
(15, NULL, 'Rafi Ahamed', 'rafiahadmed@gmail.com', 'fafsdf', NULL, 1, NULL, '2017-09-17 10:49:29', NULL),
(16, NULL, 'dfsdf sdf', 'dfgnasimvirus@gmail.com', 'asd', NULL, 1, NULL, '2017-09-17 10:51:38', NULL),
(17, NULL, 'fadand', 'famvirus@gmail.com', 'asd', NULL, 1, NULL, '2017-09-18 16:56:00', NULL),
(18, NULL, 'Ranki Banik', 'ranki@gamil.com', 'ranki', NULL, 1, NULL, '2017-09-25 13:01:37', NULL),
(19, NULL, 'Rafi Ahamed', 'rafi@ralitsoft', 'asd', NULL, 1, NULL, '2017-09-25 13:02:34', NULL),
(20, NULL, 'Aminul Khan', 'aminul@ralitsoft.com', 'aminul', NULL, 1, NULL, '2017-09-27 17:59:43', NULL),
(21, NULL, 'Yamin alam', 'yamin@ralitsoft', 'asd', NULL, 1, NULL, '2017-09-27 18:15:27', NULL),
(22, 1, 'Nazmus Shakib', 'nshakib.se@gmail.com', '$2y$10$x2hepr5ukvSJLD4LcjAjz.s2/byDbH7UpVsh8JKNDu/uGkFwAOzJS', NULL, 1, 'E4J2nnYvZtRbWtkCvUJqjsEvUD4BKKKSIuFsSfRCnlbc7oMlojo9qv6jy1Hs', '2017-09-28 09:46:54', NULL);
...
CREATE TABLE `videos` (
  ...
  `v_p_location` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1=home_page, 2=loan_page, 3=investment_page, 4=insuranceL_page, 5=lcardL_page',
  `v_embed_code` text NOT NULL COMMENT 'youtube_embed_code',
  `v_youtube_link` text COMMENT 'youtube_direct_website_link',
  `v_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '0=unPublish, 1=publish',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `videos` (`id`, `v_name`, `v_p_location`, `v_embed_code`, `v_youtube_link`, `v_status`, `created_at`) VALUES
(1, 'Devolution - One Minute Festival - 3D Animation', 1, '<iframe src="https://www.youtube.com/embed/itbB19HQMYc?showinfo=0" frameborder="0" allowfullscreen></iframe>', 'https://www.youtube.com/watch?v=itbB19HQMYc', 1, '2017-09-19 19:05:52'),
(2, 'Salt and Pepper - Romantic 1 Minute Stop Motion Animation', 1, '<iframe src="https://www.youtube.com/embed/jRUE4imKYSo?showinfo=0" frameborder="0" allowfullscreen></iframe>', 'https://www.youtube.com/watch?v=jRUE4imKYSo', 0, '2017-09-19 19:05:52'),
(3, 'The gril with a broken hearth. Stop motion - One minute', 1, '<iframe src="https://www.youtube.com/embed/9We1u7_7s4s?showinfo=0" frameborder="0" allowfullscreen></iframe>', 'https://www.youtube.com/watch?v=9We1u7_7s4s', 1, '2017-09-19 19:06:28'),
(4, 'Alert - 3d Animation 1 Minute Video', 2, '<iframe  src="https://www.youtube.com/embed/FfkbKzDnqT4?showinfo=0" frameborder="0" allowfullscreen></iframe>', 'https://www.youtube.com/watch?v=FfkbKzDnqT4', 1, '2017-09-20 05:37:40'),
(5, 'Alert - 3d Animation 1 Minute Video', 3, '<iframe  src="https://www.youtube.com/embed/FfkbKzDnqT4?showinfo=0" frameborder="0" allowfullscreen></iframe>', 'https://www.youtube.com/watch?v=FfkbKzDnqT4', 1, '2017-09-20 05:56:17'),
(6, 'Alert - 3d Animation 1 Minute Video', 1, '<iframe  src="https://www.youtube.com/embed/FfkbKzDnqT4?showinfo=0" frameborder="0" allowfullscreen></iframe>', 'https://www.youtube.com/watch?v=FfkbKzDnqT4', 1, '2017-09-20 06:00:41'),
(7, 'The Red Balloon Short Flash Animation (Student Project)', 5, '<iframe src="https://www.youtube.com/embed/OU6Pfja-FLM?showinfo=0" frameborder="0" allowfullscreen></iframe>', 'https://www.youtube.com/watch?v=OU6Pfja-FLM', 1, '2017-09-20 06:07:52'),
(8, 'How to Create YOUR 1 Minute Commercial', 2, '<iframe src="https://www.youtube.com/embed/iBHUFFWGUGc?showinfo=0" frameborder="0" allowfullscreen></iframe>', 'https://www.youtube.com/watch?v=iBHUFFWGUGc', 1, '2017-09-20 10:10:49'),
(9, 'A Secret Inside This Loan Max! - One Minute Mysteries 1 - urban exploration dead and dying retail', 2, '<iframe src="https://www.youtube.com/embed/ASh7GD85Q_k?showinfo=0" frameborder="0" allowfullscreen></iframe>', 'https://www.youtube.com/watch?v=ASh7GD85Q_k', 1, '2017-09-20 10:11:58'),
(10, 'Paying Rent vs. Getting a Home Loan / "Mortgage" - A One Minute Comparison', 2, '<iframe  src="https://www.youtube.com/embed/PN3zccgSdsY?showinfo=0" frameborder="0" allowfullscreen></iframe>', 'https://www.youtube.com/watch?v=PN3zccgSdsY', 0, '2017-09-20 10:13:07'),
(11, 'One Minute Video "The Perfectionist"', 4, '<iframe  src="https://www.youtube.com/embed/p-ql3724iDQ?showinfo=0" frameborder="0" allowfullscreen></iframe>', 'https://www.youtube.com/watch?v=p-ql3724iDQ', 1, '2017-09-20 10:53:06'),
(12, 'How To Create A Free Virtual Credit Card Yourself In One Minute', 5, '<iframe  src="https://www.youtube.com/embed/6pSluk48nmA?showinfo=0" frameborder="0" allowfullscreen></iframe>', 'https://www.youtube.com/watch?v=6pSluk48nmA', 1, '2017-09-20 10:54:11'),
(13, 'How to Create a Virtual Credit Card For You?', 5, '<iframe src="https://www.youtube.com/embed/o1BPz1zbWSc?showinfo=0" frameborder="0" allowfullscreen></iframe>', 'https://www.youtube.com/watch?v=o1BPz1zbWSc', 1, '2017-09-20 10:55:07');
...
ALTER TABLE `applyings`
  ...
  ADD KEY `carddebit_id` (`carddebit_id`),
...
--
-- Indexes for table `commentreplaies`
--
ALTER TABLE `commentreplaies`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`bloguser_id`),
...
--
-- Indexes for table `headerimages`
--
ALTER TABLE `headerimages`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `applyings`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'PrimaryKey', AUTO_INCREMENT=26;
--
...
--
ALTER TABLE `banks`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT COMMENT 'PrimaryKey', AUTO_INCREMENT=32;
--
-- AUTO_INCREMENT for table `blogs`
--
ALTER TABLE `blogs`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Primary-Key', AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `blogsubscribers`
--
ALTER TABLE `blogsubscribers`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Primary_Key', AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `cardcategories`
--
ALTER TABLE `cardcategories`
  MODIFY `id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'foreign_key', AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `categories`
  MODIFY `id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'Primary-Key', AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `commentreplaies`
--
ALTER TABLE `commentreplaies`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'Primary-Key', AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `comments`
--
ALTER TABLE `comments`
  MODIFY `id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'Primary-Key', AUTO_INCREMENT=6;
--
...
ALTER TABLE `contacts`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Primary_key', AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `headerimages`
--
ALTER TABLE `headerimages`
  MODIFY `id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'primary_key', AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `insurances`
--
ALTER TABLE `insurances`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'PrimaryKey', AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `ratings`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'PrimaryKey', AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `reviews`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'PrimaryKey', AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `users`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT COMMENT 'Primary-Key', AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT for table `videos`
--
ALTER TABLE `videos`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'PrimaryKey', AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `blogs`
  ADD CONSTRAINT `blogs_ibfk_1` FOREIGN KEY (`bloguser_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `blogs_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`);

--
-- Constraints for table `commentreplaies`
--
ALTER TABLE `commentreplaies`
  ADD CONSTRAINT `commentreplaies_ibfk_1` FOREIGN KEY (`comment_id`) REFERENCES `comments` (`id`),
  ADD CONSTRAINT `commentreplaies_ibfk_2` FOREIGN KEY (`bloguser_id`) REFERENCES `users` (`id`);
