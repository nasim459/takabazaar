...
class FormBannerController extends Controller
{
    //----Form Update Banner(form-banner-save save_banner_form)
    public function save_banner_form(Request $request) {
        //return 'Yes';
        //dd($request->all());
        ...
        if($data_ud == 'data_ud_date') {
            ...
            DB::table('banners')->where('id', $id)->update($change);
        ...
        if (isset($image)) {
            ...
            $destination_path = 'ap/images/banner/';
