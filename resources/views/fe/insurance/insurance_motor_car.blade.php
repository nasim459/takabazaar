        ...
        <div class="b-breadcrumbs f-breadcrumbs">
            <div class="container">
                <ul>
                    ...
                    <li><i class="fa fa-angle-right"></i><span>Motor Car Insurance</span></li>
                </ul>
            </div>
        </div>
        <div class="container">
            <div class="l-inner-page-container">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 b-item-apartment-block" ng-if="v.insr_type==5" ng-repeat="v in insurance_data | filter:person | filter:src_bank">
