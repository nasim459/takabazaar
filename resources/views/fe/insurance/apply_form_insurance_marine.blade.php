@section('fe_maincontent')
    ...
    @foreach($header_image as $v)
        ...
        <div class="b-inner-page-header__content">
            <div class="container">
                <div class="pull-left">
                    <h1 class="f-primary-l c-default"><i class="fa fa-briefcase"> Marine Insurance</i></h1>
                    {{--<div class="f-primary-l f-inner-page-header_title-add c-senary"><i class="fa">Create a marine insurance from here</i></div>--}}
                </div>
        ...
        <div class="b-breadcrumbs f-breadcrumbs">
            <div class="container">
                <ul>
                    ...
                    <li><i class="fa fa-angle-right"></i><span>Marine Insurance</span></li>
                </ul>
            </div>
        </div>
        <div class="container">
                            ...
                            <div class="b-some-examples__item_action- -app-box"style="margin-top: 13px;">
                                ...
                                <div class="col-xs-12 col-sm-offset-3">
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="b-form-row f-primary-l f-title-big c-secondary">Marine Insurance Apply Form</div>
                                        ...
                                        <div class="form-horizontal m-t-10">
                                            ...
                                            <input type="hidden" name="insurance" value="insr_marine">
