                        ...
                        <div class="b-breadcrumbs f-breadcrumbs">
                            <div class="container">
                                <ul>
                                    ...
                                    <li><i class="fa fa-angle-right"></i><span>Health Insurance Form</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="container">
                                        ...
                                        <div class="b-some-examples__item f-some-examples__item">
                                            <div class="b-some-examples__item_action- -app-box"style="margin-top: 13px;">
                                                ...
                                                <div class="col-xs-12 col-sm-6">
                                                    <div class="b-form-row f-primary-l f-title-big c-secondary">Health Insurance Apply Form</div>
                                                    ...
                                                    <div class="form-horizontal m-t-10">
                                                        ...
                                                        <input type="hidden" name="insurance" value="insr_health">
