@section('fe_maincontent')
    ...
    <div class="b-inner-page-header f-inner-page-header b-bg-header-inner-page">
        <div class="b-inner-page-header__content">
            <div class="container">
                <h1 class="f-primary-l c-default"><i class="fa fa-credit-card"> Debit Card</i></h1>
                <div class="f-primary-l f-inner-page-header_title-add c-senary"><i class="fa">Choose your debit card from here</i></div>
            </div>
        </div>
    </div>
        ...
        <div class="b-breadcrumbs f-breadcrumbs">
            <div class="container">
                <ul>
                    ...
                    <li><i class="fa fa-angle-right"></i><span>Debit Card</span></li>
                </ul>
            </div>
        </div>
        <div class="container">
