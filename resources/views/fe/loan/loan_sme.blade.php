@section('fe_maincontent')
    ...
    @foreach($header_image as $v)
        ...
        <div class="b-inner-page-header__content">
            <div class="container">
                <div class="pull-left">
                    <h1 class="f-primary-l c-default"><i class="fa fa-hand-o-right"> SME Lone</i></h1>
                    {{--<div class="f-primary-l f-inner-page-header_title-add c-senary"><i class="fa f-s-20">Choose your SME (small-to-medium enterprise) loan from here</i></div>--}}
                </div>
        ...
        <div class="b-breadcrumbs f-breadcrumbs">
            <div class="container">
                <ul>
                    ...
                    <li><i class="fa fa-angle-right"></i><span>SME Loan</span></li>
        ...
        <div class="container">
            <div class="l-inner-page-container">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 b-item-apartment-block" ng-if="v.loan_type == 1" ng-repeat="v in display_data | filter:person | filter:src_bank">
