@section('fe_maincontent')
    ...
    @foreach($header_image as $v)
        ...
        <div class="b-inner-page-header__content">
            <div class="container">
                <div class="pull-left">
                    <h1 class="f-primary-l c-default"><i class="fa fa-book"> Working Capital Lone</i></h1>
                    {{--<div class="f-primary-l f-inner-page-header_title-add c-senary"><i class="fa f-s-20">Choose your working capital loan from here</i></div>--}}
                </div>
        ...
        <div class="b-breadcrumbs f-breadcrumbs">
            <div class="container">
                <ul>
                    ...
                    <li><i class="fa fa-angle-right"></i><span>Working Capital Loan</span></li>
