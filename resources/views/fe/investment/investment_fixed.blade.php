@section('fe_maincontent')
    ...
    @foreach($header_image as $v)
        ...
        <div class="b-inner-page-header__content">
            <div class="container">
                <div class="pull-left">
                    <h1 class="f-primary-l c-default"><i class="fa fa-briefcase"> Investment Fixed Account</i></h1>
                    <div class="f-primary-l f-inner-page-header_title-add c-senary"><i class="fa">Take your Fixed account from here</i></div>
                </div>
                        ...
                        <div class="container">
                            <div class="l-inner-page-container">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 b-item-apartment-block" ng-if="v.invst_type==2" ng-repeat="v in investment_data | filter:person | filter:src_bank">
