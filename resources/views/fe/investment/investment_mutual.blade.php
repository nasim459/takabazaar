@section('fe_maincontent')
    ...
    @foreach($header_image as $v)
        ...
        <div class="b-inner-page-header__content">
            <div class="container">
                <div class="pull-left">
                    <h1 class="f-primary-l c-default"><i class="fa fa-briefcase"> Investment Mutual Account</i></h1>
                    {{--<div class="f-primary-l f-inner-page-header_title-add c-senary"><i class="fa">Take your Mutual account from here</i></div>--}}
                </div>
                        ...
                        <div class="container">
                            <div class="l-inner-page-container">
                                <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <form class="form-inline app-head">
                                                        ...
                                                        <div class="form-group pull-right">
                                                            ...
                                                            @if($person==1)
                                                                <div ng-model="person.invst_person_type=1"></div>
                                                            @elseif($person==2)
                                                                <div ng-model="person.invst_person_type=2"></div>
                                                            @elseif($person==3)
                                                                <div ng-model="person.invst_person_type=3"></div>
                                                            @else
                                                                <div ng-model="person.invst_person_type=''"></div>
                                                            @endif
                                                        </div>
                                    ...
                                    <div class="col-sm-12 col-md-12 b-item-apartment-block" ng-if="v.invst_type==3" ng-repeat="v in investment_data | filter:person | filter:src_bank">
                                            ...
                                            <div class="b-some-examples__item_action app-box">
                                                ...
                                                <div class="col-xs-12 col-sm-2 col-md-2 nas m-b-5">
                                                    ...
                                                    <div class="col-xs-5 col-sm-12 col-md-12">
                                                        ...
                                                        <i class="fa"><span class="ralit-r" ng-if="v.invst_person_type == 2">Business</span></i>
                                                        <i class="fa"><span class="ralit-r" ng-if="v.invst_person_type == 3">Others</span></i>
                                                    </div>
                                                </div>
