                ...
                @foreach($apply_view as $v)
                    <tr>
                        ...
                        <td class="col-xs-12 col-sm-1">
                            <a href="{{URL::to('publication-alert/'.$v->id.'/'.$pending.'/'.$table)}}" class="btn btn-default btn-xs m-l-20" title="Applying Pending"><i class="text-danger-light fa fa-warning"></i></a>
                        </td>
                        <td class="col-xs-12 col-sm-2">&nbsp;
