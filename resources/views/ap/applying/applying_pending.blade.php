    ...
    <div class="container-fluid content-change-fixed" ng-controller="homeController">
        ...
        <div class="panel panel-default m-b-0">
            <div class="table-h-t">
                ...
                <div class="col-md-3 m-t-10 text-success"><b>Apply Pending</b></div>
                <div class="col-md-4">
                ...
                @foreach($bank_view as $v)
                    <tr>
                        ...
                        <td class="col-xs-12 col-sm-1">
                            <a class="btn btn-default btn-xs m-l-20" title="Pending"><i class="text-warning-light fa fa-warning"></i></a>
                        </td>
