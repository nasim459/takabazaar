                ...
                @foreach($apply_view as $v)
                    <tr>
                        ...
                        <td class="col-xs-12 col-sm-2">&nbsp;
                            ...
                            <a class="btn btn-default btn-xs" data-toggle="modal" data-target="#{{$v->id}}p" title="Give Rating"><i class="fa fa-star-half-full"> Rating</i></a>
                        </td>
                    </tr>
                    ...
                    <div id="{{$v->id}}p" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="overflow: hidden">
                                    <div class="col-md-12">
                                        <div class="col-md-10 col-md-offset-2 f-s-14 f-f-s">
                                            ...
                                            <dl class="dl-horizontal">
                                                ...
                                                <dd>
                                                    <p class="b-stars-group" style="font-size: 18px;">
                                                        <input type="radio" name="rating" value="5"><span class="m-l-10">5 Start</span>
                                                    </p>
                                                </dd>
                                                ...
                                                <dd>
                                                    <p class="b-stars-group" style="font-size: 18px;">
                                                        <input type="radio" name="rating" value="3" checked><span class="m-l-10">3 Start</span>
                                                    </p>
                                                </dd>
