            ...
            <div class="table-h-t">
                <div class="col-md-3 m-t-5">
                    <div class="form-group">
                        <input type="text" value="Bank All List" readonly class="form-control" placeholder="Search here...">
                    </div>
                </div>
                                    ...
                                    <div class="col-md-12 f-s-14 f-f-s">
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <img src="{{ asset('ap/images/banks/'.$v->bank_image_url) }}" height="60px" width="90px" alt="pic">
                                                </div>
                                            </div>
                                            <hr>
