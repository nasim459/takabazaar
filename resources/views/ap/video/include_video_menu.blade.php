...
<div class="container-fluid content-change no-border">
    ...
    <!--<div class="col-md-1 no-border m-t-mi-6">
        ...
        <div class="col-md-12 text-center m-t-mi-6">
            <a href="{{ url('video-info') }}" class="app-menu btn btn-default text-success-light">Info Video</a>
            <a href="{{ url('video-watch') }}" class="app-menu btn btn-default text-success-light">Watch Video</a>
        </div>
        <!--end Single button-->
    </div>
    <!--end col-md-12-->
